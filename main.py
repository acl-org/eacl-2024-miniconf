...
from eacl_miniconf.load_site_data import load_site_data, reformat_plenary_data
from eacl_miniconf.data import WORKSHOP, Conference, SiteData, ByUid, Paper
...
def hydra_main(cfg: DictConfig):
    ...
    global conference
    conference = Conference.parse_file(data_dir / "new_data" / "conference.json")
